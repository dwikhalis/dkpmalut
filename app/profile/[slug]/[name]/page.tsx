...
import DataMitra from "../../../components/DataMitra";
import { useAuthStore } from "@/app/Stores/authStores";
import type { EditSource } from "@/app/components/DatasetConfig";
import Button from "@/app/components/Button";

const DatasetConfig = dynamic(
  () => import("../../../components/DatasetConfig"),
  {
...
export default function Page() {
  ...
  return (
    <div className="flex w-full min-w-0 min-h-[85vh] max-w-full overflow-hidden px-6 py-3 md:px-12 md:py-8">
      {mainPage === "main" && (
