...
import HeroKabupatenSelector from "../HeroKabupatenSelector";
import HeroDatasetResults from "../HeroDatasetResults";
...
export default function Hero() {
  ...
  function scrollToKabupatenSelector() {
    document.getElementById("jelajahi-wilayah")?.scrollIntoView({
      behavior: "smooth",
      block: "start",
    });
  }
  ...
  return (
    <>
            ...
            labels.hero_button_path.trim() ? (
              ...
              >
                <Button
                  ...
                  onClick={scrollToKabupatenSelector}
                />
      ...
      <section
        id="jelajahi-wilayah"
        className="bg-sky-50 px-4 py-16 sm:px-6 lg:px-12 lg:py-24"
        aria-labelledby="kabupaten-selector-heading"
      >
        <div className="mx-auto grid max-w-6xl items-center gap-10 overflow-hidden rounded-3xl bg-gradient-to-br from-sky-950 via-sky-800 to-cyan-600 px-5 py-10 shadow-xl sm:px-10 lg:grid-cols-[minmax(0,0.8fr)_minmax(20rem,1.2fr)] lg:px-14 lg:py-14">
          <div className="text-center lg:text-left">
            <p className="text-sm font-bold uppercase tracking-[0.2em] text-cyan-200">
              Jelajahi Wilayah
            </p>
            <h2
              id="kabupaten-selector-heading"
            ...
            <p className="mt-4 leading-relaxed text-sky-100">
              Pilih wilayah pada peta untuk menyaring data kelautan dan
          ...
          <Suspense
            fallback={
              <div className="mx-auto aspect-[4/5] w-full max-w-[27rem] animate-pulse rounded-[3rem] bg-white/10" />
            }
          >
            <HeroKabupatenSelector />
          </Suspense>
        </div>

        <div id="hasil-pencarian" className="scroll-mt-6">
