...
export default function SectionOrg() {
  return (
    <>
      ...
      <Reveal
        animation="fade-up"
        className="hidden md:flex px-12 lg:py-20 md:py-10 bg-sky-100 justify-between flex-wrap rounded-t-4xl"
      >
        {/* Side Left */}
        ...
        <div className="flex flex-col w-[50%] gap-6">
          ...
          <div className="flex gap-12">
            ...
            <Reveal animation="fade-up" delay={220} className="w-[50%]">
              <Image
                ...
                width={800}
                height={600}
                className="w-[4vw] h-[5vw] pb-3 object-contain"
                alt="Ikon Visi"
              />
          ...
          <Reveal animation="fade-up" delay={460}>
            <Link
              href="/organisasi"
              className="flex items-center gap-1 text-sky-500 hover:text-black transition-colors"
            >
      ...
      <Reveal
        animation="fade-up"
        className="md:hidden pt-6 bg-sky-100 rounded-t-4xl"
      >
        {/* Top Side */}
            ...
            >
              <div className="flex justify-center items-center">
                <Image
                  ...
                  width={800}
                  height={600}
                  className="w-[8vw] h-[10vw] pb-3 object-contain"
                  alt="Ikon Visi"
                />
              </div>
          ...
          <Reveal animation="fade-up" delay={420}>
            <div className="flex justify-center">
              <Link href="/organisasi">
                <h5 className="text-sky-500 hover:text-sky-300 py-3 transition-colors">
