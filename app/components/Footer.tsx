...
const fallbackByLocale: Record<"id" | "en", AppLabels> = {
  id: {
    ...
    footer_org_name_main: "BLUD Kawasan Konservasi",
    ...
    footer_tab_title_1: "Organisasi",
    footer_tab_title_2: "Berita",
    footer_tab_title_3: "Data",
    footer_tab_label_1_1: "Struktur",
    footer_tab_label_1_1_path: "/organisasi",
    footer_tab_label_1_2: "Visi dan Misi",
    footer_tab_label_1_2_path: "/organisasi",
    footer_tab_label_1_3: "Kontak",
    footer_tab_label_1_3_path: "/kontak",
    footer_tab_label_2_1: "Artikel",
    footer_tab_label_2_1_path: "/berita",
    footer_tab_label_2_2: "Jurnal",
    footer_tab_label_2_2_path: "/berita",
    footer_tab_label_2_3: "Peraturan",
    footer_tab_label_2_3_path: "/berita",
    footer_tab_label_3_1: "Perikanan Tangkap",
    footer_tab_label_3_1_path: "/data",
    footer_tab_label_3_2: "Perikanan Budidaya",
    footer_tab_label_3_2_path: "/data",
    footer_tab_label_3_3: "Ruang Laut",
    footer_tab_label_3_3_path: "/data",
  },
  en: {
    footer_org_logo: "/assets/logo_malut.png",
    ...
    footer_copyright_subtitle_path: "https://www.linkedin.com/in/khalisdwih/",
    footer_tab_title_1: "Organization",
    footer_tab_title_2: "News",
    footer_tab_title_3: "Data",
    footer_tab_label_1_1: "Structure",
    footer_tab_label_1_1_path: "/organisasi",
    footer_tab_label_1_2: "Vision and Mission",
    footer_tab_label_1_2_path: "/organisasi",
    footer_tab_label_1_3: "Contact",
    footer_tab_label_1_3_path: "/kontak",
    footer_tab_label_2_1: "Article",
    footer_tab_label_2_1_path: "/berita",
    footer_tab_label_2_2: "Journal",
    footer_tab_label_2_2_path: "/berita",
    footer_tab_label_2_3: "Regulations",
    footer_tab_label_2_3_path: "/berita",
    footer_tab_label_3_1: "Capture Fisheries",
    footer_tab_label_3_1_path: "/data",
    footer_tab_label_3_2: "Aquaculture Fisheries",
    footer_tab_label_3_2_path: "/data",
    footer_tab_label_3_3: "Marine Space",
    footer_tab_label_3_3_path: "/data",
  },
};
...
function FooterLink({ href, children }: { href: string; children: ReactNode }) {
  ...
  if (safeHref === "/profile/tickets") {
    return (
      <TicketHistoryLink className="cursor-pointer hover:text-stone-400">
        {children}
      </TicketHistoryLink>
    );
  }
