...
export default function ChartProductionYearFilter({ pages }: Props) {
          ...
          <div className="w-full">
            ...
            <div className="flex flex-col gap-2 mt-1">
              ...
              <div className="flex flex-col gap-3 mt-3">
                <button
                  className="flex py-1 bg-sky-600 rounded-md text-white hover:bg-sky-700 cursor-pointer justify-center items-center lg:text-sm md:text-[1.5vw] text-[2.8vw]"
