...
const LABEL_ORDER = [
  ...
  ["sectionconservation", "sectionconservation_eyebrow"],
  ["sectionconservation", "sectionconservation_title"],
  ["sectionconservation", "sectionconservation_subtitle"],
  ...Array.from({ length: 4 }, (_, index) => [
    [
      "sectionconservation",
      `sectionconservation_pillar_title_${index + 1}`,
    ] as const,
    [
      "sectionconservation",
  ...
  ["sectionconservation", "sectionconservation_journey_eyebrow"],
  ["sectionconservation", "sectionconservation_journey_title"],
  ...Array.from({ length: 4 }, (_, index) => [
    [
      "sectionconservation",
      `sectionconservation_step_title_${index + 1}`,
    ] as const,
    [
      "sectionconservation",
  ...
  ["secone", "secone_button_label"],
  ["secone", "secone_button_path"],
  ...
  ["secsix", "secsix_title"],
  ["secsix", "secsix_eyebrow"],
  ["secsix", "secsix_subtitle"],
  ...Array.from(
    { length: 15 },
    (_, index) => ["secsix", `secsix_question_${index + 1}`] as const,
  ),
  ...Array.from(
    { length: 15 },
    (_, index) => ["secsix", `secsix_answer_${index + 1}`] as const,
  ),
  ...
  ...[
    ...
    "focus_title",
    "focus_item_title_1",
    "focus_item_description_1",
    "focus_item_title_2",
    "focus_item_description_2",
    "focus_item_title_3",
    "focus_item_description_3",
    "cta_eyebrow",
    "cta_title",
    "cta_content",
    "cta_button_1_label",
    ...
    (field) => ["page_organization", `page_organization_${field}`] as const,
  ),
  ...
  ...[
    ...
    "cta_button_2_label",
    "cta_button_2_path",
  ].map((field) => ["page_explore", `page_explore_${field}`] as const),
  ...[
    "eyebrow",
    "title",
    "subtitle",
    ...
    "cta_button_2_label",
    "cta_button_2_path",
  ].map((field) => ["page_rates", `page_rates_${field}`] as const),
  ...[
    "eyebrow",
    "title",
    "subtitle",
    ...
    "cta_button_2_label",
    "cta_button_2_path",
  ].map((field) => ["page_regulations", `page_regulations_${field}`] as const),
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h4 className="min-w-0 break-words text-base font-bold text-slate-800 [overflow-wrap:anywhere]">
            {title}
          </h4>
      ...
      <div className={`${isOpen ? "visible" : "invisible h-0 pointer-events-none overflow-hidden"} grid gap-3 ${isOpen ? "p-4" : "px-4"}`}>
        {children}
      </div>
    </div>
  );
    ...
    <section className="overflow-hidden rounded-2xl bg-white shadow-md">
      ...
      >
        <span className="min-w-0 flex-1">
          ...
          <span className="block min-w-0 break-words text-xs text-slate-500 [overflow-wrap:anywhere]">
            component: {component}
          </span>
        </span>
      ...
      <div className={`${isOpen ? "visible" : "invisible h-0 pointer-events-none overflow-hidden"} ${isOpen ? "p-4" : "px-4"}`}>{children}</div>
    </section>
  );
}
...
export default function DashAppCMS() {
  ...
  const showBottomActions = checkedChangeCount > 0 || Boolean(localeEditSession);
  ...
  return (
    <div className="relative flex min-h-[70vh] w-full flex-col gap-6">
                      ...
                      >
                        {visibleItems.map((label) => {
                          ...
                          return (
                            ...
                            >
                              <div>
                                <label className="block min-w-0 break-words text-sm font-bold text-slate-700 [overflow-wrap:anywhere]">
                                  {label.target}
                                </label>
      ...
      {bottomActions.mounted && (
        <div className={`${bottomActions.closing ? "bottom-menu-collapse" : "bottom-menu-expand"} sticky bottom-0 z-30 mt-auto flex w-full flex-col gap-3 rounded-2xl border border-slate-200 bg-white/95 p-4 shadow-[0_-10px_30px_rgba(15,23,42,0.14)] backdrop-blur md:flex-row md:items-center md:justify-end`}>
          <button
            type="button"
